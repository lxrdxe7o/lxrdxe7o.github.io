  ...
  return (
    <section className="section contact" id="contact">
      ...
      <footer className="footer">
        <p>&copy; {new Date().getFullYear()} xero. Built with React & Three.js</p>
      </footer>
    </section>
  )
}
